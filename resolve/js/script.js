    ...
    window.addEventListener("scroll", function () {
      ...
      if (
        window.scrollY + window.innerHeight >
          how_it_works_desktop.offsetTop + how_it_works_desktop.offsetHeight ||
      ...
      if (
        window.scrollY + window.innerHeight >
        how_it_works_desktop.offsetTop + how_it_works_desktop_box_each * 2
      ) {
      ...
      if (
        window.scrollY + window.innerHeight >
        how_it_works_desktop.offsetTop + how_it_works_desktop_box_each * 3
      ) {
...
// Agregar event listener para el evento 'hashchange'
